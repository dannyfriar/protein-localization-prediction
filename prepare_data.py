...
def fasta_to_pandas(file):
	...
	# fasta_data['second_is_a'] = []
	# fasta_data['second_is_k'] = []
	...
	for fasta in fasta_sequences:
		...
		# fasta_data['second_is_a'].append(1 if sequence[1]=='A' else 0)
		# fasta_data['second_is_k'].append(1 if sequence[1]=='K' else 0)
